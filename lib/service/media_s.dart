...
import 'package:flutter_bili/feature/video/model/play_url_model.dart';
...
class MediaS extends BaseAudioHandler with ChangeNotifier, SeekHandler {
  ...
  Future<void> initAndLoad(
    ...
    try {
      if (_currentLibrary == PlayerLibraryM.mediaKit) {
        ...
        await _initFvp(videoUrl, headers);
      }
      _startHeartbeat();
      notifyListeners();
    } catch (e) {
  ...
  Future<void> _initFvp(String videoUrl, Map<String, String> headers) async {
    _initFvpStreams();
